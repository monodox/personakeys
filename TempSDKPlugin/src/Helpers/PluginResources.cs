namespace Loupedeck.TempSDKPlugin
{
    using System;
    using System.IO;
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.TempSDKPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.TempSDKPlugin.Resources.Resource.txt`.
